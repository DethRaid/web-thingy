...
#[get("/authorize")]
pub fn authorize<'r>(oauth: OAuthRequest<'r>, state: State<MyState>) -> Result<Response<'r>, OAuthFailure> {
    state.endpoint()
...
pub fn authorize_consent<'r>(oauth: OAuthRequest<'r>, allow: Option<bool>, state: State<MyState>)
...
pub fn token<'r>(mut oauth: OAuthRequest<'r>, body: Data, state: State<MyState>)
                 -> Result<Response<'r>, OAuthFailure>
{
    oauth.add_body(body);
    state.endpoint()
...
pub fn refresh<'r>(mut oauth: OAuthRequest<'r>, body: Data, state: State<MyState>)
                   -> Result<Response<'r>, OAuthFailure>
{
    oauth.add_body(body);
    state.endpoint()
...
#[get("/")]
pub fn protected_resource<'r>(oauth: OAuthRequest<'r>, state: State<MyState>)
                              -> impl Responder<'r>
{
